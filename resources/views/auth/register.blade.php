        ...
        <div class="mx-auto mb-4 w-fit">
            ...
            <form class="w-full rounded bg-white shadow-lg shadow-gray-500/50" method="POST"
                ...
                <div class="p-6">
                    ...
                    <span class="text-sm" id="contract">
                        En cochant, vous acceptez d'avoir reçu l’accord préalable du tuteur qui est nécessaire et requis. Il doit être adulte, avoir au moins 18 ans.
                    </span>
                </div>
                <div
