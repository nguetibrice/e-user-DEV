    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="{{ route('dashboard') }}"><img src="{{ asset('images/logo.png') }}"
                        alt="logo" style="height: 60px" /></a>
                <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard') }}"><img src="{{ asset('images/logo.png') }}"
                        alt="logo" style="width: 50px; height: 40px" /></a>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile">
                        <p>
                            <b>Solde : {{ session('wallet_balance') }}</b>
                        </p>
                    </li>
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
                            id="profileDropdown">
                            <img src="{{ asset('image/default-profile-picture.png') }}" alt="profile" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                            aria-labelledby="profileDropdown">
                            <div class="mt-2 flex flex-col gap-y-1 items-center">
                                <img src="{{ asset('image/default-profile-picture.png') }}" alt="profile photo" style="width: 80px; height: 80px">
                            ...
                            <a href="{{ route('account_settings') }}" class="dropdown-item">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas shadow-lg" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('recharge.view') }}">
                            <i class="icon-layout menu-icon"></i>
                            <span class="menu-title">Recharge</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('package.lang') }}">
                            <i class="icon-columns menu-icon"></i>
                            <span class="menu-title">Produits disponible</span>
                        </a>
                    </li>
                </ul>
            </nav>
