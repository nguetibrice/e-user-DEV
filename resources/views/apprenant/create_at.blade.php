...
@Section('main')
    ...
    <div class="h-screen bg-gray-200 px-10">
                        ...
                        <div>
                            ...
                            <div class="text-gray-600 mb-8">
                                <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                    data-cfemail="ff9b9a9290bf9b9a9290d18b9a8c8bd1">[email&#160;protected]</a> Please click
                ...
                <div x-show.transition="step != 'complete'">
                    ...
                    <div class="border-b-2 py-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div class="flex-1">
                                <div x-show="step === 1">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Apprenant</div>
                                </div>

                                <div x-show="step === 2">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Tuteur</div>
                                </div>

                                <div x-show="step === 3">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Paiement</div>
                                </div>
                            </div>
                    ...
                    <a href="{{ url('/liste/user') }}"
                        class="w-32 text-xs items-center md:w-64 focus:outline-none border mb-4 border-transparent mr-4 py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-red-600 font-medium">Retour</a>


                    <!-- Step Content -->
                    <form class="py-10" id="myForm" method="POST" action="" enctype="multipart/form-data">
                        @csrf
                        <div x-show.transition.in="step === 1">
                            ...
                            <div class="border-b-2 py-4">
                                ...
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                    <div class="mb-5">
                                        <label for="firstname" class="font-bold mb-1 text-gray-700 block">Nom</label>
                                        <input type="text"
                                    ...
                                    <div class="mb-5">
                                        <label for="email" class="font-bold mb-1 text-gray-700 block">Prénom</label>
                                        <input type="email"
                                            class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                ...
                                <div class="mb-5">
                                    <label for="email" class="font-bold mb-1 text-gray-700 block">Télépone</label>
                                    <input type="email"
                                        class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                            ...
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div class="mb-5">
                                    <label for="email" class="font-bold mb-1 text-gray-700 block">Birthday</label>
                                    <input type="date"
                                        class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
                                        placeholder="Enter your email address...">
                                </div>
                                ...
                                <div class="mb-5">
                                    <label for="email" class="font-bold mb-1 text-gray-700 block">password</label>
                                    <div class="relative">
                            ...
                            <div class="flex items-center mt-4 h-3">
                                <div class="w-2/3 flex justify-between h-2">
                                    <div :class="{
                                        'bg-red-400': passwordStrengthText == 'Faible' || passwordStrengthText ==
                                            'Moyen' || passwordStrengthText == 'Fort'
                                    }"
                                        class="h-2 rounded-full mr-1 w-1/3 bg-gray-300"></div>
                                    <div :class="{
                                        'bg-orange-400': passwordStrengthText == 'Moyen' || passwordStrengthText ==
                                            'Fort'
                                    }"
                                        class="h-2 rounded-full mr-1 w-1/3 bg-gray-300"></div>
                                    <div :class="{ 'bg-green-400': passwordStrengthText == 'Fort' }"
                        ...
                        <div x-show.transition.in="step === 2">
                            <div class="mb-5">
                                <div class="mb-5">
                                    <label for="email" class="font-bold mb-1 text-gray-700 block"></label>
                                    ...
                                    <div class="flex mb-5">
                                        <label
                                            ...
                                            <div class="select-none text-gray-700"><b>es-tu un apprenant</b></div>
                                        </label>
                                    </div>
                    ...
                    <div class="flex justify-between">
                        <div class="w-1/2">
                            <button x-show="step > 1" @click="step--"
                                class="w-32 focus:outline-none py-2 px-5 rounded-lg shadow-sm text-center text-red-600 bg-white hover:bg-red-400 font-medium border">Previous</button>
                        </div>

                        <div class="w-1/2 text-right">
                            <button x-show="step < 3" @click="step++"
                                class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-green-500 hover:bg-indigo-600 font-medium">Next</button>

                            <button @click="step = 'complete'" x-show="step === 3" name="submit" type="submit"
                                class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-green-600 font-medium">Complete</button>
                        </div>
                    </div>
                </div>
            </div>
