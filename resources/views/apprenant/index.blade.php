...
@Section('main')
        ...
        <div class="mt-10 ml-10 mx-4 ">
            <a href="{{url('/create/apprenant/tuteur')}}"
                    x-show="step < 3"
                    @click="step++"
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xl px-4 mt-10">
                ...
                <table class="w-full">
                  <thead>
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                      ...
                      <th class="px-4 text-center py-3">Action</th>
                    </tr>
                  </thead>
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 text-center py-3 text-sm">
                        <a tooggle="modifier" href="#"
                        class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-gray-600 font-medium" 
